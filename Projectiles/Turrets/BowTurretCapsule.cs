...
namespace EnemyMods.Projectiles.Turrets
{
    public class BowTurretCapsule : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            player.AddBuff(mod.BuffType("BowTurret"), 18002);
            MPlayer mplayer = (MPlayer)player.GetModPlayer(mod, "MPlayer");
            mplayer.bowTurret = true;
            int p = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("BowTurret"), projectile.damage, projectile.knockBack, projectile.owner, 0, aiOut);
            return true;
        }
